 ...
 *  }
 * )
 * @ApiFilter(SearchFilter::class, properties={"firstName":"word_start", "lastName":"word_start", "company":"word_start"})
...
class Customer
{
     ...
     * @Assert\Length(min=3, minMessage="Le nom doit faire plus de 3 caractères")
     */
    private $lastName;
     ...
     * @Assert\Email(message="Le format de votre email doit être valide")
     */
    private $email;
     ...
     * (montant total hors factures payées ou annulées)
     * @Groups({"customers_read"})
     *
     * @return float
     */
